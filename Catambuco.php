<html>
	<head>
		<title>GASTRONARI&Ntilde;O | Catambuco</title>
		...
		<!--Contenido-->
	  	<div class = "w3-container w3-blue-black">
	  		<dir class = "w3-container w3-blue-black">
	  			<h6 style="text-align: center; font-size: 30;" >CUY ASADO</h6>
	  			<img src="img/catambuco1.jpg" alt="Lights" style="width: 100%; height: 400;">
	  		</dir>
			...
			<div class='w3-half w3-container' style='height: 300px;'> <!--de aqui fue-->
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<img src="img/catambuco1.jpg" alt="Lights" style="width: 100%; height: 265px;">
					</div>
