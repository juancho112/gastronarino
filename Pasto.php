<html>
	<head>
		<title>GASTRONARI&Ntilde;O | Pasto</title>
	...
	<body>
		...
		<!--Contenido-->
	  	<div class = "w3-container w3-blue-black">
	  		<dir class = "w3-container w3-blue-black w3-center">
	  			<h6 style="text-align: center; font-size: 30;" >FRITO PASTUSO</h6>
	  			<img src="img/frito.jpg" alt="Lights" style="width: 90%; height: 400;">
	  		</dir>
			...
			<div class='w3-half w3-container' style='height: 300px;'> <!--de aqui fue-->
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<img src="img/frito1.jpg" alt="Lights" style="width: 100%; height: 265px;">
					</div>
					...
					<div class='w3-container w3-center'>
						<div class='w3-panel w3-leftbar w3-sand w3-xxlarge w3-serif'>
							...
							<a id='Ref'><h6 class='w3-opacity'>los precios de Alimentación promedian los $ 20.000  </h6></a>
			...
			<div class='w3-half w3-container' style='height: 550px;'>
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<h6 style="text-align: center;">Restaurante Ramón Tragón</h6>
						<a href=''><img src='img/ramon.png' alt='Norway' width='570' height='350' title='Restaurante'></a>
					...
					<div class='w3-container w3-center'>
						<div class='w3-panel w3-leftbar w3-sand w3-xxlarge w3-serif'>
							...
							<a href='https://www.google.com.co/maps/dir//Restaurante+Ram%C3%B3n+Trag%C3%B3n,+Carrera+39+No.+16B-36,+Santa+Ana,+Pasto,+Nari%C3%B1o/@1.2207231,-77.2869573,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x8e2ed3807fc85bdd:0xd86470a8be99873f!2m2!1d-77.2867534!2d1.2223213' id='Ref'><h6 class='w3-opacity'>Catambuco, Pasto, Nariño </h6></a>
				...
				<div class='w3-card-4' style='width: 600px;'>
					...
					<div class='w3-container w3-center'>
						<div class='w3-panel w3-leftbar w3-sand w3-xxlarge w3-serif'>
							...
							<a id='Ref'>
							<h6 class='w3-opacity'>los precios de Alimentación promedian los $ 30.000 </h6></a>
			...
			<dir class = "w3-container w3-blue-black">
	  			<h6 style="text-align: center; font-size: 30;" >LAPINGACHOS</h6>
	  			<img src="img/lapi.jpg" alt="Lights" style="width: 100%; height: 450;">
	  		</dir>
				...
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<p id='parrafo'>
							...
							<h6 style="text-align: center;">DESCRIPCION</h6>
							Este es un plato tipico de la region andina sur de Colombia, basicamente son tortillas asadas o fritas, hechas de papas cocidas, aplastadas y rellenas con queso.
						</p>
						<img src="img/lapi.jpg" alt="Lights" style="width: 100%; height: 280px;">
					</div>
			...
			<div class='w3-half w3-container' style='height: 550px;'>
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						<h6 style="text-align: center;">LUGARES RECOMENDADOS</h6>
						<h6 style="text-align: center;">Picanteria Ipiales</h6>
