	...
	<body>
		...
		<!--Contenido-->
	  		...
	  		<dir class = "w3-container w3-blue-black">
	  			<h6 style="text-align: center; font-size: 30;" >CREMA DE LANGOSTINO</h6>
	  			<img src="img/lango2.jpg" alt="Lights" style="width: 90%; height: 400;">
	  		</dir>
			...
			<div class='w3-half w3-container' style='height: 300px;'> <!--de aqui fue-->
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<img src="img/lango.jpg" alt="Lights" style="width: 100%; height: 265px;">
					</div>
			...
			<div class='w3-half w3-container' style='height: 550px;'>
				<div class='w3-card-4' style='width: 600px;'>
					<div class='w3-container w3-rigth'>
						...
						<h6 style="text-align: center;">La Ramada</h6>
						<a href=''><img src='img/tuma.png' alt='Norway' width='570' height='350' title='Restaurante'></a>
						<a href='#' id='Ref2' ' title=''><h5 style='text-align: left;'></h5></a>
						<p id='parrafo'>
					...
					<div class='w3-container w3-center'>
						<div class='w3-panel w3-leftbar w3-sand w3-xxlarge w3-serif'>
							...
							<a href='https://www.google.com.co/maps/dir/Pasto,+Nari%C3%B1o/La+Ramada+Restaurante+Bar,+Tumaco,+San+Andres+de+Tumaco,+Nari%C3%B1o/@1.428704,-78.5940107,9z/data=!3m1!4b1!4m13!4m12!1m5!1m1!1s0x8e2ed48761b92a73:0x44a368566cc3a522!2m2!1d-77.285787!2d1.2058837!1m5!1m1!1s0x8e2d0223afe0ea1f:0x17b69a08068ce326!2m2!1d-78.7553081!2d1.818589' id='Ref'><h6 class='w3-opacity'>La Ramada Restaurante Bar, Tumaco, San Andrés de Tumaco, Nariño </h6></a>
